...
if __name__ == "__main__":
    ...
    sample_book_1 = {'id': 'book1', 'title': 'The Great Novel', 'authors': ['Author A'], 'description': '...', 'genres': 'Fiction'}
    sample_book_2 = {'id': 'book2', 'title': 'Another Story', 'authors': ['Author B'], 'description': '...', 'genres': 'Fantasy'}
